    ...
    >
      ...
      <div className="relative w-full flex justify-center items-center">
        ...
        <motion.button
         ...
         className="absolute left-4 md:left-10 top-[65%] -translate-y-1/2
        ...
        <motion.button
          ...
          className="absolute right-4 md:right-10 top-[65%] -translate-y-1/2
           bg-white/90 p-3 rounded-full shadow-lg z-30"
  ...
  return (
    <div
      ...
      className="box-border content-stretch flex flex-col gap-[40px] md:gap-[120px]
                 ...
                 pb-[40px] md:pb-[20px] pt-[0] md:pt-[60px]
...
const togglePreference = (pref: Preference) => {
  setFormData((prev) => {
    // Si se hace click en "Sin preferencias"
    if (pref === "noPreferences") {
      return {
        ...prev,
        noPreferences: !prev.noPreferences,
        celiac: false,
        vegetarian: false,
        lactoseIntolerant: false,
      };
    ...
    // Si se hace click en cualquier otra preferencia
    return {
      ...prev,
      [pref]: !prev[pref],
      noPreferences: false,
        ...
        <div className="box-border content-stretch flex flex-col gap-[24px] md:gap-[32px] items-center justify-end px-[30px] md:px-[60px] lg:px-[120px] xl:px-[180px] py-[80px] md:py-[100px] relative w-full">
          ...
          >
            <div className="content-stretch flex flex-col items-center relative shrink-0 w-full">
              <p className="font-['Roboto_Slab',serif] font-light italic leading-[normal] relative shrink-0 text-[#452746] text-[64px] md:text-[100px] lg:text-[130px] text-center px-4">Confirmar Asistencia</p>
          ...
          >
            ...
            <div className="flex flex-col gap-[12px] w-full">
              ...
              <motion.div 
                className="content-stretch flex gap-[12px] items-center relative shrink-0 cursor-pointer"
                onClick={() => togglePreference("lactoseIntolerant")}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <motion.div 
              ...
              <motion.div 
                className="content-stretch flex gap-[12px] items-center relative shrink-0 cursor-pointer"
                onClick={() => togglePreference("noPreferences")}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <motion.div 
            ...
            <div className="flex flex-col gap-[12px] w-full">
              <div className="box-border content-stretch flex gap-[8px] items-center overflow-clip px-0 py-[12px] relative rounded-[6px] shrink-0">
                <p className="font-['Roboto_Slab',serif] font-light leading-[normal] not-italic relative shrink-0 text-[15px] md:text-[16px] lg:text-[17px] text-black">
                  <span>{`¡Cuéntanos algo! ¿Algún mensaje, canción o idea? ¡Todo vale!`}</span>            
