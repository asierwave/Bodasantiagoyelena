...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center relative shrink-0 w-full">
      <p className="font-['Migra_Italic:Extralight_Italic',sans-serif] italic leading-[normal] relative shrink-0 text-[#452746] text-[0px] text-[40px] text-center w-full">
...
function Frame34() {
  return (
    <div className="bg-neutral-50 relative rounded-[4px] shrink-0 size-[35.5px]">
      <div aria-hidden="true" className="absolute border-4 border-neutral-50 border-solid inset-[-2px] pointer-events-none rounded-[6px]" />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-full items-start relative shrink-0">
      <Frame30 />
      <Frame33 />
      <Frame36 />
    </div>
...
function Frame38() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center overflow-clip px-[24px] py-[16px] relative rounded-[8px] shrink-0">
      <p className="font-['Migra:Extralight',sans-serif] leading-[normal] not-italic relative shrink-0 text-[32px] text-black text-nowrap whitespace-pre">
        <span>{`Traeré `}</span>
        <span className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid underline">a un invitado</span>
      </p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="bg-white relative rounded-tl-[16px] rounded-tr-[16px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[#452746] border-[4px_4px_0px] border-solid inset-0 pointer-events-none rounded-tl-[16px] rounded-tr-[16px]" />
      <div className="flex flex-row items-center size-full">
...
function Frame39() {
  return (
    <div className="bg-neutral-50 relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Migra:Extralight',sans-serif] leading-[normal] not-italic relative shrink-0 text-[32px] text-black text-nowrap whitespace-pre">El nombre del invitado/a</p>
        </div>
      </div>
    </div>
  );
...
function Frame40() {
  return (
    <div className="bg-neutral-50 relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Migra:Extralight',sans-serif] leading-[normal] not-italic relative shrink-0 text-[32px] text-black text-nowrap whitespace-pre">Su mail</p>
        </div>
      </div>
    </div>
  );
...
function Frame41() {
  return (
    <div className="bg-neutral-50 relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Migra:Extralight',sans-serif] leading-[normal] not-italic relative shrink-0 text-[32px] text-black text-nowrap whitespace-pre">Su teléfono</p>
        </div>
      </div>
    </div>
  );
...
function Frame52() {
  return (
    <div className="bg-white relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[0px_4px_4px] border-black border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[80px] items-center pb-[40px] pt-0 px-[80px] relative w-full">
          <div className="flex flex-row items-center self-stretch">
            <Frame42 />
          </div>
          <div className="flex flex-row items-center self-stretch">
