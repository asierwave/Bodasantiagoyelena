...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0">
      <p className="font-['Migra:Extralight',sans-serif] leading-[normal] not-italic relative shrink-0 text-[50px] text-black text-nowrap whitespace-pre">{`~S & E~`}</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Migra_Italic:Extralight_Italic',sans-serif] gap-[16px] grow italic items-center justify-center leading-[normal] min-h-px min-w-px relative shrink-0 text-[100px] text-nowrap whitespace-pre">
      <p className="relative shrink-0 text-[#faf7fa]">{`~Santiago & Elena~`}</p>
